...
class Login extends Component {
  ...
  homeclick = (props) => {
    console.log("child calling");
     ...
     let result=this.child.current.login(this.state.username,this.state.password,1)
     return result;
           ...
           <div className="main" style ={{display : set_visibility, overflow:"hidden"}}>
                ...
                <form className="primary">
                    ...
                    <div > 
                        ...
                        <input type="text"  value={this.state.username}  onChange={this.name.bind(this)} placeholder="username" />
                        <p>{this.state.usererror}</p>
                    </div><br/>
                    <div > 
                        <label>PASSWORD</label>
                        <input type="text"  value={this.state.password} onChange={this.passwordupdate.bind(this)} placeholder="password" />
